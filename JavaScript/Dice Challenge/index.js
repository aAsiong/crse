...
document.getElementById("play1").setAttribute("src", "./images/dice" + randomNumber1 + ".png");

document.getElementById("play2").setAttribute("src", "./images/dice" + randomNumber2 + ".png");
